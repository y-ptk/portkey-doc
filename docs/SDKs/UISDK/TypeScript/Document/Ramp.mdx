...
<HighlightBlock>
  Before using this component, please make sure you are
  <a href="/docs/SDKs/UISDK/TypeScript/Document/SignIn"> logged-in</a>.
  <br />
  <br />
  Before using this component, we assume that you are already familiar with the
  <a href="/docs/SDKs/UISDK/TypeScript/Document/Configuration">
    &nbsp;basic configuration&nbsp;
  </a>
  of Portkey.
</HighlightBlock>
...
<div
  ...
  <div style={{ width: "32%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-buying.png"
      width={"99.5%"}
  ...
  <div style={{ width: "32%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-fiat-currency-selecting.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
  <div style={{ width: "32%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-token-selecting.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
...
<div
  ...
  <div style={{ width: "32%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-limit-amount.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
  <div style={{ width: "32%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-selling.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
  <div style={{ width: "32%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-manage-information-synchronization.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
...
<div
  ...
  <div style={{ width: "49%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-wallet-security-modal.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
  <div style={{ width: "49%" }}>
    ...
    <img
      src="/img/ui-sdk/ui-for-limit-modal.png"
      width={"99.5%"}
      style={{ border: "1px solid #dee2e8" }}
    />
  </div>
