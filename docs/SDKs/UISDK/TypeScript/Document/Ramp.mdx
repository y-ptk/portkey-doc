...
<div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'start', width: '100%'}}>
  <div style={{width: '49%'}}> 
    <div style={{textAlign: 'center', color: '#999'}}> transfer limit notice </div>
    <img src='/img/ui-sdk/ui-for-wallet-security-modal.png' width={'99.5%'} style={{border: '1px solid #dee2e8'}} />
  </div>
  <div style={{width: '49%'}}> 
    <div style={{textAlign: 'center', color: '#999'}}> wallet security notice </div>
    <img src='/img/ui-sdk/ui-for-limit-modal.png' width={'99.5%'} style={{border: '1px solid #dee2e8'}} />
  </div>
</div>
