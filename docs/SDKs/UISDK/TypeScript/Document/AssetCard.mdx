...
| Property          | <div style={{width: 350}}>Description</div>          | <div style={{width: 100}}>Type</div>  | Required  | <div style={{width: 100}}>Default</div> | Version  |
| :---------------- | :--------------------------------------------------- | :------------------------------------ | :-------- | :------------ | :--------- |
| backIcon          | Back button that controls the display of page header | ReactNode                             | false     | —             |            |
| networkType       | Control network type                                 | NetworkType, 'MAINNET' \| 'TESTNET'   | false     | —             | 2.0.0      |
