...
| <del>phoneCountry</del> | <del>List of countries that support sending SMS verification codes</del>                       | <del>IPhoneCountry</del>                                                                       | -             | 2.0.0   |
| extraElement      | Customized content                                                                                   | ReactNode                                                                                      | -             |         |
| extraElementList  | Customized content                                                                                   | ReactNode[]                                                                                    | -             | 2.0.0   |
...
| privacyPolicy     | Link that directs to the privacy policy                                                              | string                                                                                         | -             | 2.0.0   |
| validateEmail     | Customized rules for email verification                                                              | (v:string)=>Promise<any\>                                                                      | -             |         |
| <del>validatePhone</del> | <del>Customized rules for phone number verification</del>                                     | <del>(v:string)=>Promise<any\></del>                                                           | -             | 2.0.0   |
