...
| handleSetLoginGuardian | Execute contract method that sets or removes guardian | () => Promise<any\>                               | -             | V1.5.1  |
...
| handleSetLoginGuardian | Execute contract method that sets or cancels guardian | () => Promise<any\>                                                                       | -             | V1.5.1  |
