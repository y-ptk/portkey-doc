...
| :----------------- | :--------------------------------------------------------- | :------------------------------------------------------------------------------------- | :------------ | :------ |
| ~~chainId~~        | ~~Chain ID where user account is registered~~              | ~~ChainId~~                                                                            | -             | V1.5.0  |
| originChainId      | ID of the chain where user account is registered           | ChainId                                                                                | AELF          | V1.5.0  |
| targetChainId      | ID of the chain which the current operation targets        | ChainId                                                                                | -             | V1.5.0  |
