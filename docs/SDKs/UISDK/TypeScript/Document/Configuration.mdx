...
| serviceUrl | You must configure this if you want to enable on/off ramp services. | string | [https://aa-portkey.portkey.finance](https://aa-portkey.portkey.finance) |