...
**Description:** *Used only for Email Credentials. Called when program has gotten a verification code from the user. This continues the process for verifying Email Credentials.*
...
**Description:** *Used only for Email Credentials. Confirm sending of verification code. This continues the process for verifying Email Credentials.*

## CancelCodeVerification()

**Description:** *Used only for Email Credentials. Cancels verification of code and stops verification process.*

## ResendVerificationCode()

**Description:** *Used only for Email Credentials. Resends the verification code.*
