...
* **Security**: User assets are safeguarded through the <u>social recovery</u> mechanism, overseen by their trusted guardians and verifiers.
* **Decentralisation**: External service providers function as <u>verifiers</u> to boost the level of decentralisation in the social recovery process.
