...
![receive tokens within the aelf network](</img/receive tokens within the aelf network.png> "receive tokens within the aelf network")
...
![receive tokens cross-chain from other networks](</img/receive tokens cross-chain from other networks.png> "receive tokens cross-chain from other networks")
...
![receive NFTs](</img/receive NFTs.png> "receive NFTs")
