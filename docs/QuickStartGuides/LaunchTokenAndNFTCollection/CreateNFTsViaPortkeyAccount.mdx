...
Create by using ManagerForwardCall in the [**AA contract**](/docs/APIReference/ContractAPI) and calling the CreateToken method in the [**agent contract**](/docs/APIReference/ContractAPI).
...
Create by using ManagerForwardCall in the [**AA contract**](/docs/APIReference/ContractAPI), calling the ForwardCall method in the [**ProxyAccount contract**](/docs/APIReference/ContractAPI), and calling the [**Token contract**](/docs/APIReference/ContractAPI) via the ProxyAccount contract.
...
Issue by using ManagerForwardCall in the [**AA contract**](/docs/APIReference/ContractAPI), calling the ForwardCall method in the [**ProxyAccount contract**](/docs/APIReference/ContractAPI), and calling the [**Token contract**](/docs/APIReference/ContractAPI) via the ProxyAccount contract.
...
![create-collections-use-portkey-mainchain](/img/quick-start/create-collections-use-portkey-mainchain-v2.png)
