...
For example, `'AELF'` means MainChain, `'tDVV'` means dAppChain.
...
You can see detailed type definition in [source code](https://github.com/Portkey-Wallet/portkey-providers/blob/master/packages/types/src/chain.ts).
...
You can find the complete type definition like `Accounts` in [source code](https://github.com/Portkey-Wallet/portkey-providers/blob/master/packages/types/src/provider.ts).
