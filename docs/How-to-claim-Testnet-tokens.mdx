...
2. Enter your wallet address there to manually claim 1,000 Testnet ELF tokens.
   * Each address is eligible for one claim only. If you don't know how to obtain your wallet address, please visit [asset receiving tutorial](/docs/How-to-receive-assets "").
