...
4. Repeat the above process until enough codes have been obtained and verified. Then you can click "Confirm" to complete your removal.
   * Once a login device has been removed, you can only [log back in](/docs/How-to-log-in-to-my-Portkey-account "") there via social recovery or scanning the QR code.
