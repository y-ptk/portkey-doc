...
4. Your account has just been created.
   Upon account creation, the info you use to register is set as your first guardian as well as the [<u>login account</u>](/docs/What-is-a-login-account ""). To strengthen account security, Portkey encourages you to add more guardians before you start managing your assets or using any DApps.
