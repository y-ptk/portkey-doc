...
### To send tokens within the aelf network (for instance to other Portkey accounts or wallets on aelf)

![](</img/token send (same chain).png> "Send assets within the aelf network")
...
![](</img/send assets cross-chain to other networks.png> "Send assets cross-chain to other networks")
...
> Portkey enables seamless cross-chain transfers from the aelf network to various popular blockchains, including Ethereum, Tron, BNB Smart Chain (BSC), Arbitrum One, Solana, Polygon, Optimism, AVAX C-Chain, TON, and Base.
